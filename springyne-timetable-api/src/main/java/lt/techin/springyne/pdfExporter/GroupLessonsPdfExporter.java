...
private BaseFont baseFont = BaseFont.createFont(Matcher.quoteReplacement("~/springyne-timetable-api/src/main/resources/fonts/LiberationSans-Regular.ttf"), BaseFont.IDENTITY_H, BaseFont.EMBEDDED);//    private BaseFont baseFont = BaseFont.createFont(Matcher.quoteReplacement(System.getProperty("user.dir")) + "/src/main/resources/fonts/LiberationSans-Regular.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED);
